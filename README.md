...
- **`next/image`.** Not used — the original has no bitmap images (visuals are CSS gradients, SVG, and a striped screenshot placeholder). `next/font` is used for the three Google fonts.
